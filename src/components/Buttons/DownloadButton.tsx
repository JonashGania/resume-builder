...
const DownloadButton: React.FC<ResumePreviewProps> = ({ formData, resumeRef }) => {
    return (
        <button 
            onClick={() => handleDownloadPDF(resumeRef, formData)} 
            className="px-4 py-2 laptop:py-3 laptop:bg-black rounded-md flex items-center gap-2 laptop:mt-8 justify-self-end"
        >
            <svg xmlns="http://www.w3.org/2000/svg" height={15} width={15} viewBox="0 0 512 512" className="block laptop:hidden">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" height={20} width={20} viewBox="0 0 512 512" className="hidden laptop:block">

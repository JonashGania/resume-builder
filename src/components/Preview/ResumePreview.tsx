...
import { handleDownloadPDF } from "../../helpers/utils"
...
const ResumePreview: React.FC<ResumePreviewProps> = ({ formData }) => {
    ...
    return (
        <div className="w-[55%]">
            <div ref={resumeRef} className="resume-preview font-lato bg-white min-h-[550px] rounded-md px-16 py-16">
            ...
            <button 
                onClick={() => handleDownloadPDF(resumeRef, formData)} 
                className="px-4 py-3 bg-black rounded-md flex items-center gap-2 mt-8 justify-self-end"
            >

const Footer = () => {
    return (
        <footer className="w-full mt-40 h-20 flex flex-col items-center justify-center">
            <span className="pb-2">Developed by Jonash Gaña</span>
            <div className="flex items-center gap-4">
                <a href="https://www.facebook.com/jonashgania/" target="_blank">
                ...
                <a href="https://www.linkedin.com/in/jonash-gaña-74b1a12a7/" target="_blank">
                ...
                <a href="https://github.com/JonashGania" target="_blank">
